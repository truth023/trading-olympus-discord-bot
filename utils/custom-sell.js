...
async function customSellAmount(interaction, poolId, firstSymbol, secondSymbol) {
    ...
    .setCustomId("solana-custom-sell")
    .setTitle("Custom-Buy");
    ...
    .setLabel("Input Sol Amount for selling token.")
    .setValue(`0`)
...
module.exports = {customSellAmount};